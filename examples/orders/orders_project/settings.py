"""Minimal Django settings for the Rakaia orders (versioned handlers) sample."""
...
ASGI_APPLICATION = "orders_project.asgi.application"
...
# demo — the orders example never actually broadcasts.
CHANNEL_LAYERS = {
    "default": {
