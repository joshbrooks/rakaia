"""Minimal Django settings for the Rakaia projection-cookbook sample."""
...
ASGI_APPLICATION = "cookbook_project.asgi.application"
...
# demo — the cookbook example never actually broadcasts.
CHANNEL_LAYERS = {
    "default": {
